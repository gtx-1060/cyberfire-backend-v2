...
from .tournaments import is_tournament_exists_royale
from src.app.models.royale.stage import Stage, kills_association_table, damagers_association_table
...
from src.app.schemas.royale.stage import StageCreate, StageEdit
...
def create_stages(stages: List[StageCreate], tournament_id: int, db: Session):
    if not is_tournament_exists_royale(tournament_id, db):
